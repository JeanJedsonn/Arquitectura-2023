...
###############################################################
#	Las diferencias principales entre este ejemplos y los #
# exibidos en el libro es que aquí se hace uso de encabezados #
# que permite definir de antemano los datos a usar y las dire-#
# cciones de los mismos, además de que en estos ejemplos se u-#
# sán procedimientos del sistema que permiten leer, imprimir  #
# por pantalla y terminar las ejecución del programa princi-  #
# pal, para que los ejemplos del libro sean programas funcio- #
# nales se deben incluir estás cosas.                         #
###############################################################